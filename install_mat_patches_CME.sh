...
#
# needs parameters(?) to select the inventory file and/or limited host ( inventory should use standard names qa1, qa1, uat1, prod1, etc. )
#
...
ansible-playbook fetch_patches.yaml -i cme_inventory.yaml --ask-pass
...
ansible-playbook extract_patches.yaml -i cme_inventory.yaml -l prod2, --ask-pass

#
# execute patch tasks on weblogic inventory hosts

echo "Patching servers with mat_patches role"
ansible-playbook mat_patches.yaml -i cme_inventory.yaml -l prod2, --ask-pass
