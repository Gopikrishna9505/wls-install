...
ansible-playbook fetch_patches.yaml -i CPR_inventory.yaml --ask-pass
...
ansible-playbook extract_patches.yaml -i CPR_inventory.yaml -l prod2 --ask-pass

#
# execute patch tasks on weblogic inventory hosts

echo "Patching servers with mat_patches role"
ansible-playbook mat_patches.yaml -i CPR_inventory.yaml -l prod2 --ask-pass
