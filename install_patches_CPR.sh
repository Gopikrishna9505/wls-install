...
ansible-playbook stage_patches.yaml -i CPR_inventory.yaml --ask-pass

#
# push patch files from ansible controller to weblogic hosts

echo "Copying patch files to target hosts and extracting"
ansible-playbook extract_patches.yaml -i CPR_inventory.yaml -l dev1, --ask-pass

#
# stop servers on the weblogic host

echo "Stopping servers with mat_stop..."
ansible-playbook mat_stop.yaml -i CPR_inventory.yaml -l dev1, --ask-pass

#
# install patch(es)

#  echo "Installing patch(es)"
ansible-playbook apply_opatch.yaml -i CPR_inventory.yaml -l dev1, --ask-pass
...
# rollback patch(es)
  ...
  ansible-playbook rollback_opatch.yaml -i CPR_inventory.yaml -l dev1 --ask-pass
...
# start servers on the weblogic host
  ...
  ansible-playbook mat_start.yaml -i CPR_inventory.yaml -l dev1, --ask-pass
