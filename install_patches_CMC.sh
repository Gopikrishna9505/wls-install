...
ansible-playbook stage_patches.yaml -i CMC_inventory.yaml --ask-pass
...
ansible-playbook mat_stop.yaml -i CMC_inventory.yaml -l dev1, --ask-pass

#
# install patch(es)

#  echo "Installing patch(es)"
ansible-playbook apply_opatch.yaml -i CMC_inventory.yaml -l dev1, --ask-pass
...
# rollback patch(es)
  ...
  ansible-playbook rollback_opatch.yaml -i CMC_inventory.yaml -l dev1 --ask-pass
...
# start servers on the weblogic host
  ...
  ansible-playbook mat_start.yaml -i CMC_inventory.yaml -l dev1, --ask-pass
